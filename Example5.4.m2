-* 
This code confirms computations in Example 5.4.
...
dim IEmpty, degree IEmpty

r1 = flatten entries Y^{0};
r2 = flatten entries Y^{1};


for ct in {(1,1),(1,2),(1,3),(2,2),(2,3),(3,3)} do (
    S = join(r1_{0..(ct_0)-1}, r2_{ct_0..(ct_1)-1 + ct_0});
    IS = I(H(S));
    print(ct, dim IS, degree IS);
    )


nonMin = I(H({1,3,5,7,9,11}));
isPrime nonMin
dim nonMin
